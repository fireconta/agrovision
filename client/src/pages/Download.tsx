          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <Card className="border-none shadow-xl overflow-hidden relative">
              ...
              <CardContent className="pt-8 pb-8 px-6 text-center">
                ...
                <h2 className="text-2xl font-bold mb-2">{config.app.name} APK</h2>
                <p className="text-sm text-muted-foreground mb-8">Versão 2.4.0 • Android • 45MB</p>
                
                <Button 
                  size="lg" 
                  className="w-full h-14 text-lg rounded-xl shadow-lg shadow-primary/20 mb-4"
                  onClick={handleDownload}
                >
                  {downloadStarted ? "Baixando..." : "Baixar Agora"}
                </Button>
                
                <p className="text-xs text-muted-foreground">
                  Ao clicar, o download iniciará automaticamente.
                </p>
              </CardContent>
            </Card>
